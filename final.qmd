...
Parameters:
```{r}
B_R=0.1 # B is the efficiency with which resident whales consume and assimilate salmons
...
B_T=0.2 # B is the efficiency with which transient whales consume and assimilate pinnipeds
...
r_S=1 # growth rate of salmon
K_S=2000 # Carrying capacity of salmon
b=0.8 # attack rate on salmon
```
