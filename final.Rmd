...
In model B, Pinnipeds compete with salmon over smaller fish. So resident whales and transient whales has a mutualistic relation; consuming one type of prey will make the other flourish, hence increasing the other predator. This might explain why there are two types of whales in the first place. See food web figure below.

![Food web for model B](fin-1.png){width=300}
...
```{r}
# Resident whales
plot(out[,1],out[,2],xlab="time",ylab="Population Density",type='l',lwd=2,
